...
Pod::Spec.new do |s|
  s.name         = "react-native-firebase-ntl-pdpa-consent"
  ...
  s.source       = { :git => "https://github.com/suradisworkspace/react-native-firebase-ntl-pdpa-consent.git", :tag => "#{s.version}" }

  s.source_files = "ios/**/*.{h,m,mm}"

  # Firebasee dependency
